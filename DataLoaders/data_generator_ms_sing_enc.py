...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, pairs, betas: dict, batch_size, tokenizer, units, max_len, vocab_size, subject='2', pre_load_betas=False, shuffle=True, training=False):
    ...
    def __data_generation(self, batch):
        ...
        for k, i in enumerate(idx):
            betas_batch[k] = self.betas[sub[k]][i,:]
