...
import os, sys
sys.path.append("/home/hpcgies1/rds/hpc-work/NIC/Masters-Thesis/AttemptFour")
import numpy as np
...
def load_tokenizer():
    ...
    return tf.keras.preprocessing.text.tokenizer_from_json(json.load(open(f"{thesis_dir}/TrainData/tokenizer_73k.json", "r")))
...
def get_nsd_keys(subj: str = '2') -> (list, list):
    ...
    df = pd.read_csv(f'{thesis_dir}/TrainData/subj0{subj}_conditions.csv')
...
def main():
    ...
    train_keys, val_keys, _ = get_nsd_keys('2') # (10_000,)
